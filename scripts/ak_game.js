...
window.addEventListener("load", function() {
    ...
    //CARGA DE RECURSOS
    Q.load(["main_theme.ogg", "main_theme.mp3", "jump.ogg", "jump.mp3", "alex.png", "bird.png", "frog.png", "frog.json", "scorpion.png", "tiles.png", "coin.ogg", "coin.mp3", "punch.ogg", "fist.png"], function() {
